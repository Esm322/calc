...
exports.disButtons = disButtons;
exports.disDisplay = disDisplay;
function disDisplay() {
...
exports.signs = exports.procent = exports.plusMinus = exports.pendingOper = exports.outText = exports.numbers = exports.newNumber = exports.decimal = exports.currentNumber = exports.ac = void 0;
...
_model.model.forEach(function (block) {
  ...
  if (block.type === 'display') {
    html = (0, _templates.disDisplay)(block);
  } else if (block.type === 'buttons') {
    html = (0, _templates.disButtons)(block);
  }
  ;
...
var numbers = document.querySelectorAll('.num'),
  ...
  newNumber = false,
  pendingOper = '';
exports.pendingOper = pendingOper;
...
function pressButt(number) {
  if (newNumber) {
    ...
    exports.newNumber = newNumber = false;
  } else {
